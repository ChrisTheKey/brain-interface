#!/usr/bin/env bash
# Reports what is actually up right now. Reads the machine, assumes nothing.
...
printf '  ollama:     '
if zero_http_ok "http://127.0.0.1:11434/api/tags"; then
  echo "up on 127.0.0.1:11434"
else
  echo "down (ZERO reports LOCAL MODEL OFFLINE and keeps running)"
fi
